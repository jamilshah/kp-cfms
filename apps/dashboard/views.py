...
class EBaldiaDashboardView(TemplateView):
    """
    Main e-Baldia landing page showing all modules.
    
    Features:
    - Publicly accessible (no login required)
    - Shows all available modules (CFMS, Property, ADP, etc.)
    - Active modules require authentication on click
    - Coming soon modules redirect to coming soon page
    """
    
    template_name = 'dashboard/e_baldia.html'
    ...
    def get_context_data(self, **kwargs) -> Dict[str, Any]:
        ...
        context['total_orgs'] = Organization.objects.filter(is_active=True).count()
...
class ComingSoonView(TemplateView):
    ...
    Publicly accessible to show information about planned features.
    """
    ...
    def get_context_data(self, **kwargs) -> Dict[str, Any]:
        ...
        # Get module from query parameter
        module = self.request.GET.get('module', '')
        
        # Define module information
        modules_info = {
            'adp': {
                'name': 'ADP Project Management',
                'icon': '<i class="bi bi-diagram-3-fill"></i>',
                'description': 'Comprehensive Annual Development Program planning, monitoring, and execution system for capital projects.',
                'features': [
                    'Project planning and approval workflows',
                    'Budget allocation and fund release tracking',
                    'Physical and financial progress monitoring',
                    'Contractor and consultant management',
                    'Milestone tracking and reporting',
                    'Integration with CFMS budgeting module'
                ],
            ...
            'pension': {
                ...
                'description': 'Complete pension management system for retirees including calculation, disbursement, and tracking.',
                'features': [
                    'Retiree database management',
                    'Automated pension calculation',
                    'Monthly disbursement processing',
                    'Arrears and adjustments',
                    'Pensioner life certificate tracking',
                    'Integration with payroll and finance'
                ],
            ...
            'hrm': {
                ...
                'description': 'Comprehensive HR system for employee lifecycle management from recruitment to retirement.',
                'features': [
                    'Employee database and service records',
            ...
            'assets': {
                'name': 'Moveable Asset Management',
                'icon': '<i class="bi bi-truck"></i>',
                'description': 'Track and manage moveable assets including vehicles, furniture, equipment, and inventory.',
                'features': [
            ...
            'ebilling': {
                'name': 'E-billing for Taxation & Fees',
                'icon': '<i class="bi bi-receipt-cutoff"></i>',
                'description': 'Digital billing system for property tax, water tax, trade licenses, and other municipal fees.',
                'features': [
            ...
            'complaints': {
                'name': 'Citizen Complaint Management',
                'icon': '<i class="bi bi-megaphone-fill"></i>',
                'description': 'Public grievance redressal system for tracking and resolving citizen complaints.',
                'features': [
            ...
            'procurement': {
                ...
                'description': 'End-to-end procurement system from requisitions to contracts and vendor management.',
                'features': [
        ...
        # Get module info or default
        module_data = modules_info.get(module, {
            'name': 'Module',
            'icon': '<i class="bi bi-box"></i>',
            'description': 'This module is currently under development.',
            'features': [],
            'estimated_release': 'To be announced'
        })
        ...
        context.update({
            ...
            'module_features': module_data['features'],
            'estimated_release': module_data['estimated_release']
        })
